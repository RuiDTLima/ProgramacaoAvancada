package ist.meic.pa.FunctionalProfilerExtended.testStora;

import ist.meic.pa.FunctionalProfilerExtended.testStora.sampleC.Example;
...
public class Tests {
    ...
    static void test14() {
        Example.test();
        ist.meic.pa.FunctionalProfilerExtended.testStora.sampleA.Example.test();
        ist.meic.pa.FunctionalProfilerExtended.testStora.sample0.Example.test();
    }
